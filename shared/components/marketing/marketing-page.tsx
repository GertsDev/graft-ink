    ...
    return (
      ...
      >
        <div className="flex flex-col items-center justify-center text-center">
          {!showGraft && !showTagline && (
            <motion.div
              ...
              className="text-primary text-8xl font-bold md:text-9xl lg:text-[12rem]"
            >
          ...
          {showGraft && (
            ...
            >
              ...
              <motion.div
                ...
                className="bg-primary/20 absolute inset-0 -z-10 scale-150 rounded-full blur-3xl"
              />
            </motion.div>
          )}
          ...
          {showTagline && (
            <motion.div
              ...
              className="text-muted-foreground text-2xl font-light md:text-4xl lg:text-5xl"
            >
              <motion.span
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
        ...
        <motion.div
          ...
          className="bg-gradient-radial from-primary/10 absolute inset-0 via-transparent to-transparent"
        />
        ...
        >
          ...
          >
            <div className="border-muted rounded border px-2 py-1 font-mono text-xs">
              SPACE
            </div>
            <span>to skip</span>
          </motion.div>
      ...
      <div className="from-background via-background to-muted/20 min-h-screen bg-gradient-to-br">
        ...
        <section className="relative flex min-h-screen justify-center overflow-hidden px-6 py-12 lg:px-8">
          ...
          >
            ...
            >
              <span className="text-primary">Graft your way</span>
              <br />
              to productivity
            </motion.h1>
          ...
          >
            <div className="from-primary/10 rounded-3xl border bg-gradient-to-r via-purple-500/10 to-pink-500/10 p-12">
              ...
              <p className="text-muted-foreground mx-auto mb-8 max-w-2xl text-xl">
                ...
                the Graft Method. Your time is your most valuable asset - invest
                wisely.
              </p>
